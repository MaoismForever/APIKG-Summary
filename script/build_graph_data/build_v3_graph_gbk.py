...
test = GraphLoadUtil();
collection = GraphLoadUtil.load_doc("jdk8", "v1")


docs = collection.get_document_list()
graph_data_path = PathUtil.graph_data(pro_name="jdk8", version="v1")
graph_data: GraphData = GraphData.load(graph_data_path)
new_graph_data_path = PathUtil.graph_data(pro_name="jdk8", version="v3")
