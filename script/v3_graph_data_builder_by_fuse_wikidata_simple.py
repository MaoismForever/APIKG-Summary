...
def build_v3_graph_for_pro(pro_name):
    ...
    word2vec_model_path = PathUtil.sim_model(pro_name=pro_name, version="v2_1", model_type="avg_w2v")
    ...
    graph_data = builder.build_v3_graph_from_cache_simple(pro_name=pro_name,
                                                          ...
                                                          project_title_search_cache_path=None,
                                                          project_wikidata_item_cache_path=None,
